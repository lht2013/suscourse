...
jQuery(function(){
	jQuery.fn.extend({
		SimpleTree:function(options){
			...
			/* 设置所有超链接不响应单击事件 */
			this.find("a").click(function(){ jQuery(this).parents("li").click(); return false; });
			...
			this.find("li").click(function(){
				 ...
				 * 否则修改其 show 属性为 true
				 */
				if(jQuery(this).next("ul").attr("show")=="true"){
					jQuery(this).next("ul").attr("show","false");					
				}else{
					jQuery(this).next("ul").attr("show","true");
				}
